...
test("/wizardsvault/objectives - Status check ", async ({request}) => {


    const response = await request.get(`https://api.guildwars2.com/v2/wizardsvault/objectives?access_token=${API_KEY}`)
    await expect(response.status()).toBe(200)
